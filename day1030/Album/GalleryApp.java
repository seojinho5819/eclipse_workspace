...
public class GalleryApp extends JFrame implements ActionListener{
	...
	String dir="C:/Users/SeoJinHo/eclipse-workspace1/SeProject/res/travel2/";
	String[] src= {
	...
	public void prev(){
		if(n >=1 ) {		
			...
			JOptionPane.showMessageDialog(this, "첫번째 이미지 입니다");
			
	}
	public void next() {
		//배열을 넘어서지 않는 범위 내에서 ++허용
		if(n < src.length-1) {
			n++;
		}else {
